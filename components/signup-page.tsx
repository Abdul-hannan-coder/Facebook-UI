      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-lg border border-gray-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
            ...
            <button
              type="button"
              className="w-full bg-white border-2 border-gray-200 text-gray-700 hover:border-purple-500 hover:text-purple-600 transition-all duration-300 rounded-lg py-3 font-medium flex items-center justify-center space-x-2 text-sm sm:text-base"
            >
