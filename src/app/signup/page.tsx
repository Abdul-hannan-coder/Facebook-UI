...
export default function SignupPage() {
  ...
  const { signup, isLoading, error, isAuthenticated, resetError } = useAuth();
        ...
        <div className="w-full max-w-md">
          ...
          >
            ...
            <div className="space-y-4 mb-8">
              <Button variant="outline" className="w-full h-12 rounded-xl border-slate-200 hover:bg-slate-50 gap-3 font-bold text-slate-700 hover:text-black">
            ...
            <form className="space-y-5" onSubmit={handleSignup}>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input 
                    ...
                    className="h-12 pl-12 rounded-xl border-slate-200 focus:ring-primary/20 focus:border-primary"                                               
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  className="h-12 px-4 rounded-xl border-slate-200 focus:ring-primary/20 focus:border-primary"                                                  
                  required
                />
              </div>
              <Button 
