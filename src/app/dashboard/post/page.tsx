  ...
  return (
    <div className="p-4 md:p-8 min-h-screen">
      <div className="mb-6 md:mb-8">
        <h1 className="text-2xl md:text-3xl font-black text-slate-900 mb-1">Create Facebook Post</h1>
        <p className="text-xs md:text-sm text-slate-500 font-bold">Create and publish a new Facebook post</p>
      </div>
